...
const AllTouristsSpotDtls = () => {
    ...
    return (
        <div>
            ...
            <div className=" items-center top-1">
                <div className="mt-20">
                    ...
                    <div className="mt-14 ml-5">
                        <h2 data-aos="fade-down" data-aos-duration="600" className="lg:text-5xl text-3xl font-bold text-blue-900">Our Information</h2>
            ...
            <button onClick={BookNow} className="btn bg-teal-500 ml-[200px] lg:ml-[500px] text-white font-semibold hover:text-teal-500 hover:bg-white uppercase">Book Now</button>
