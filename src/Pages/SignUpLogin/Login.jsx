                    ...
                    <div className="card bg-base-100 w-full bg-[url('https://i.ibb.co/MGFNk2D/Kolsay.jpg')] max-w-sm shrink-0 shadow-2xl">
                        <form onSubmit={handleLogin} className="card-body">
                            ...
                            <div className="form-control mt-6">
                                <button className="btn bg-teal-500 font-bold uppercase text-white hover:text-teal-500 hover:bg-white">Login</button>
                            </div>

                            <div className="text-center">
                                <p className="font-serif text-white">Don't have an account please <Link className="text-sky-500 font-bold uppercase" to='/signup'>Sign Up</Link> Page</p>
                            </div>
