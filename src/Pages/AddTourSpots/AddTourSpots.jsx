...
const AddTourSpots = () => {
    const handleAddTourSpots = e =>{
        ...
        const newTourSpot = {name, email, tourists_spot_name, country_name, seasonality, location, average_cost, travel_time, totalVisitorsPerYear, image, short_description}
        console.log(newTourSpot);

        fetch('https://tourism-management-server-phi.vercel.app/addtourSpot', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            if(data.insertedId){
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    title: 'Added Tour Spot has been success',
    ...
    return (
        <div>
            ...
            <div className="p-10">
                <form onSubmit={handleAddTourSpots}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 justify-around">
                        ...
                        <div className="form-control">
                            ...
                            <select type="text" name="seasonality" className="select select-bordered w-full max-w-xs font-bold font-serif">
                    ...
                    {/* Add Books */}
                    <input type="submit" name="Add Spots" value="Add Spots" className="w-full my-4 btn bg-green-400 text-white" />
                </form>
            </div>
        </div>
    );
