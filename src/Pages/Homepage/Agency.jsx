        ...
        <div className="bg-gray-100 p-5">
            <div className="mt-28 ml-10 grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="relative">
                    <img className="w-[50%] absolute lg:ml-60 ml-36 shadow-2xl" src="/public/Images/Images.jpg" alt="" />
                    <img className="w-[50%] lg:ml-64 ml-40 mt-8" src="/public/Images/Images.jpg" alt="" />
                </div>
            </div>
