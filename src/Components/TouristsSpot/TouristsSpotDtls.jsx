    ...
    return (
        <div>
            ...
            <div className="items-center top-1">
                ...
                <div className="flex">
                <button onClick={BookNow} className="btn bg-teal-500 text-white font-semibold ml-[550px] mt-14 hover:text-teal-500 hover:bg-white uppercase">Book Now</button>
...
export default TouristsSpotDtls;